...
bool D3DManager::Initialize(int screenWidth, int screenHeight, bool vsync, HWND hwnd, bool fullScreen, float screenDepth, float screenNear)
{
	...
	//use the factory to create an adapter for teh primary graphics interface(video card)
	...
	//get the number of modes that fit the adapter output(monitor)
	...
	//get teh adapter(video card) description
	...
	//convert the name of the video card to a character array and then store it
	...
	//set teh width and height of the buffer
	...
	if (m_vsyncEnabled)//if vsync is enabled
	{
	...
	//set the handle for teh window to render to
	...
	//dont set the advacned flags
	swapChainDesc.Flags = 0;

	//set the feature level to d3d11
	featureLevel = D3D_FEATURE_LEVEL_11_0;

	//create the swapchain,direct3d device and d3d device context
	...
	//get teh pointer to the back buffer
	...
	//initialize teh depth buffer desc
	...
	//create the texture for the depth buffer using this filled out desc
	...
	//initialize teh desc of the stencil state
	...
	//bind the render target view and teh depth stencil buffer to the output render pipeline
...
void D3DManager::BeginScene(float red, float green, float blue, float alpha)
{
	...
	//set the color to clear the buffer to
	color[0] = red;
	color[1] = green;
	color[2] = blue;
	color[3] = alpha;
